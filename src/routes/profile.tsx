...
import { getInventory, getProgress } from '~/lib/progress'
...
function ProfilePage() {
  ...
  return (
    <div className="space-y-4 px-4 pt-4">
      <h1 className="display text-[28px] text-gold">Pilot Dossier</h1>
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-[12px] text-white/50">{q.data?.id ?? 'local orbit'}</div>
        </div>
      </div>
