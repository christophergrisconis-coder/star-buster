...
export const STORE_CATALOG: StoreItem[] = [
  ...
  { id: 'nebula-boost-2', kind: 'nebula-booster', name: 'Cascade Pair', blurb: 'Two first-move cascade insurances', price: 340, currency: 'stardust', minSector: 3, preview: 'nebula', grants: { 'nebula-boost': 2 } },
